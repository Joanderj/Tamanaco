...
$pdf->SetTitle('Listado de Cargos');
...
$pdf->Cell(0, 10, 'Listado de Cargos', 0, 1, 'C');
$pdf->Ln(5);
...
if ($resultado->num_rows > 0) {
    ...
    $tbl = '<table border="1" cellpadding="6" style="border-collapse:collapse;">
                <thead>
                    <tr style="background-color:#0066CC; color:#FFFFFF;">
                        ...
                        <th width="90%" align="center">Nombre</th>
                    </tr>
                </thead>
                <tbody>';
    ...
    while ($fila = $resultado->fetch_assoc()) {
        $tbl .= '<tr>
                    <td width="10%" align="center">' . $fila['id_cargo'] . '</td>
                    <td width="90%" align="center">' . $fila['nombre_cargo'] . '</td>
                 </tr>';
    }
    $tbl .= '</tbody></table>';
    ...
    $pdf->Cell(0, 10, 'No se encontraron cargos en la base de datos.', 0, 1, 'C');
}
...
$pdf->Output('listado_cargos.pdf', 'I');
?>
