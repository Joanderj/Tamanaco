...
<hr>
 ...
 <div class="flex flex-col items-center mb-6">
    <div class="bg-blue-500 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-lg mb-4">
        <i class="fas fa-pallet text-3xl"></i> <!-- Ícono de etiquetas -->
    </div>
    <h2 class="text-3xl font-extrabold text-gray-800">Formulario de Producto</h2>
    <p class="text-gray-600 mt-2 text-center">Registra los Productos y sus Cantidades a su Almacen Correspondiente.</p>
</div>
    <?php
...
<?php endif; ?>
  ...
  <form id="formRegistrarsucursal" action="entrada_producto.php" method="POST">
...
<div class="flex justify-between mt-4 space-x-4">
    ...
    <!-- Botón Regresar -->
    <button type="button" onclick="location.href='inventario_repuesto.php';"
