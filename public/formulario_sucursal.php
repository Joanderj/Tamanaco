...
<hr>
 ...
 <div class="flex flex-col items-center mb-6">
    ...
    <p class="text-gray-600 mt-2 text-center">Registra las Sucursales y vincula las sedes con la sucursales de forma rápida y organizada.</p>
</div>
    <?php
...
<?php endif; ?>
  ...
  <form id="formRegistrarsucursal" action="registrar_sucursal.php" method="POST">
    ...
    <div class="mb-4">
      <label for="nombre" class="block text-gray-700 font-bold mb-2"><i class="fas fa-store text-blue-500 mr-2"></i> Nombre de la sucursal <span class="text-red-600">*</span></label>
      <input type="text" id="nombre" name="nombre"  placeholder="Ingrese el nombre de la sucursal"
       ...
       <small id="mensaje-error-input" class="text-red-500 hidden">Esta sucursal ya existe</small>
            <small id="mensaje-exito-input" class="text-green-500 hidden">¡Esta sucursal está disponible!</small>
            <small class="text-gray-500">Ejemplo: PELTAN</small>
    </div>

    <!-- Selector de País y Estado (área modificada) -->
    <div class="mb-4">
                <div>
                    <label for="pais" class="block text-gray-700 mb-2"><i class="fas fa-flag text-blue-500 mr-2"></i>País<span class="text-red-600">*</span></label>
                    <select 
                        id="pais" 
                        name="pais"
                    ...
                    >
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<option value='".htmlspecialchars($row["id"])."'>".htmlspecialchars($row["paisnombre"])."</option>";
                            }
                        }
                        $conexion->close();
                        ?>
...
<div class="mb-4">
  ...
  <i class="fas fa-link text-blue-500 mr-2"></i>¿Deseas vincular esta sucursal a una sede?
  </label>
  <select 
