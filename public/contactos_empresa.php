...
<div class="flex flex-col items-center mb-6">
    ...
    <h2 class="text-3xl font-extrabold text-gray-800">Contacto de la Empresa</h2>
    <p class="text-gray-600 mt-2 text-center">Consulta y actualiza la información de contacto de la empresa.</p>
</div>
...
?>
  ...
  <!-- Formulario -->
  <form action="guardar_cambios_contactos_empresa.php" method="POST">
    <!-- Teléfonos -->
    <div class="grid grid-cols-1 gap-6 mb-6">
      <div class="relative">
        <label for="telefono1" >Teléfono 1:</label>
        <input type="number" id="telefono1" name='tlf1' value="<?php echo $empresa['telefono_1']; ?>" placeholder="Ejemplo: +58 123-456-7890" class="w-full p-3 border border-gray-300 rounded-lg bg-gray-100 focus:outline-none" />
      <div class="relative">
        <label for="telefono2" class="block font-medium text-gray-600">Teléfono 2:</label>
        <input type="text" id="telefono2" name='tlf2' value="<?php echo $empresa['telefono_2']; ?>" placeholder="Ejemplo: +58 987-654-3210" class="w-full p-3 border border-gray-300 rounded-lg bg-gray-100 focus:outline-none"  />
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
      <div class="relative">
        <label for="email1" class="block font-medium text-gray-600">Correo Electrónico 1:</label>
        <input type="email" id="email1" name='cr1' value="<?php echo $empresa['correo_1']; ?>" placeholder="Ejemplo: contacto@empresa.com" class="w-full p-3 border border-gray-300 rounded-lg bg-gray-100 focus:outline-none" />
      </div>
      <div class="relative">
        <label for="email2" class="block font-medium text-gray-600">Correo Electrónico 2:</label>
        <input type="email" id="email2" name='cr2' value="<?php echo $empresa['correo_2']; ?>" placeholder="Ejemplo: soporte@empresa.com" class="w-full p-3 border border-gray-300 rounded-lg bg-gray-100 focus:outline-none" />
      </div>
    </div>
