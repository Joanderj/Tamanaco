...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-6">
        <div class="flex flex-col items-center mb-6">
            ...
            <h2 class="text-3xl font-extrabold text-gray-800">Actualizar Inventario de productos</h2>
...
?>
    ...
    <!-- Formulario General -->
<form id="formRegistrarsucursal" action="actualizar_producto_traslado.php" method="POST" onsubmit="return validarAlmacenes()">
    <!-- Nombre de la sucursal -->
    <div class="mb-4">
        <div>
            <label for="producto" class="block text-gray-700 mb-2">
                <i class="fas fa-box text-blue-500 mr-2"></i>Producto<span class="text-red-600">*</span>
            </label>
            <select 
                id="producto" 
                name="producto"
            ...
            >
                ...
                $query = "SELECT id_producto, nombre_producto FROM producto ORDER BY nombre_producto ASC";
...
function verificarCantidad() {
    ...
    if (productoId && almacenId) {
        fetch(`verificar_inventario_producto.php?producto=${productoId}&almacen=${almacenId}`)
