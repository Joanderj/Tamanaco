 ...
 <div class="container mx-auto px-4 py-6">
        <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
            <div class="flex flex-col items-center mb-6">
                ...
                <h2 class="text-3xl font-extrabold text-gray-800">Formulario de Cargo</h2>
...
<div id="mensaje-global" class="hidden bg-red-100 text-red-700 p-4 rounded-lg mb-4">
        <strong id="tipo-mensaje-global"></strong> <span id="texto-mensaje-global"></span>
            ...
            <form action="guardar_cargo.php" method="POST" class="space-y-4">
                <!-- Nombre del Cargo -->
                <div>
                    <label for="nombre_cargo" class="block font-semibold flex items-center">
                        <i class="fas fa-user-tie text-blue-500 mr-2"></i> <!-- Ícono de cargo -->
                        Nombre del Cargo: <span class="text-red-600">*</span>
                    </label>
                    <input type="text" id="nombre_cargo" name="nombre_cargo"
                           placeholder="Ingrese el nombre del cargo"
                           class="w-full border border-gray-300 rounded-lg p-2" required
                           oninput="convertirMayusculas(this); validarNombreCargo()">
                    <small id="mensaje-error-nombre" class="text-red-500 hidden">Este nombre de cargo ya existe.</small>
                    <small id="mensaje-exito-nombre" class="text-green-500 hidden">¡Este nombre de cargo está disponible!</small>
                    <small class="text-gray-500">Ejemplo: Gerente de Ventas</small>
                </div>

                <!-- Descripción del Cargo -->
                <div>
                    <label for="descripcion" class="block font-semibold flex items-center">
                        <i class="fas fa-align-left text-blue-500 mr-2"></i> <!-- Ícono de descripción -->
                        Descripción:
                    </label>
                    <textarea oninput="convertirMayusculas(this)" id="descripcion" name="descripcion"
