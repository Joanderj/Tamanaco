...
<div class="p-6 bg-gray-50 rounded ">
 ...
 <!-- Opciones: Tareas, Actividades y Plan de Mantenimiento -->
<div class="flex justify-center gap-4 mb-6">
  <button onclick="window.location.href='tareas.php'" class="bg-blue-500 text-white py-2 px-4 rounded-lg shadow-md hover:bg-blue-600 focus:ring-2 focus:ring-blue-300 focus:outline-none">
    <i class="fas fa-list-alt mr-2"></i> Tareas
  </button>
  <button onclick="window.location.href='actividades.php'" class="bg-blue-500 text-white py-2 px-4 rounded-lg shadow-md hover:bg-blue-600 focus:ring-2 focus:ring-blue-300 focus:outline-none">
    <i class="fas fa-calendar-check mr-2"></i> Actividades
  </button>
  <button onclick="window.location.href='planes.php'" class="bg-blue-500 text-white py-2 px-4 rounded-lg shadow-md hover:bg-blue-600 focus:ring-2 focus:ring-blue-300 focus:outline-none">
    <i class="fas fa-cogs mr-2"></i> Planes
  </button>
</div>

  <!-- Nuevo diseño abajo -->
  <div class="flex flex-col items-center mt-6 p-4 border rounded-lg bg-blue-50 shadow-inner">
    <i class="fas fa-tools text-blue-400 text-6xl mb-4"></i>
    <p class="text-blue-600 text-lg font-bold">Área de Mantenimiento</p>
    <p class="text-blue-500 text-sm">Gestiona y organiza tus tareas y actividades aquí.</p>
  </div>
<!-- Gráfica -->
<div class="mt-6">
  <canvas id="maintenanceChart" class="w-full max-w-sm mx-auto"></canvas>
</div>

<script>
  // Configuración de la gráfica con Chart.js
  const ctx = document.getElementById('maintenanceChart').getContext('2d');
  const maintenanceChart = new Chart(ctx, {
    type: 'bar', // Tipo de gráfica (puedes cambiarlo a 'doughnut' o 'line')
    data: {
      labels: ['Tareas', 'Actividades', 'Planes'], // Categorías
      datasets: [{
        label: 'Cantidad Total',
        data: [50, 30, 10], // Datos de ejemplo: personalizables
        backgroundColor: [
          'rgba(54, 162, 235, 0.7)', // Azul para tareas
          'rgba(75, 192, 192, 0.7)', // Verde para actividades
          'rgba(255, 99, 132, 0.7)'  // Rojo para planes
        ],
        borderColor: [
          'rgba(54, 162, 235, 1)',
          'rgba(75, 192, 192, 1)',
    ...
    options: {
      ...
      scales: {
        y: {
          beginAtZero: true, // Eje Y inicia en 0
          title: {
            display: true,
