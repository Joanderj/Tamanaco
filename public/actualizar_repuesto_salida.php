    ...
    if ($repuesto && $cantidad && $almacen) {
        ...
        if ($resultado->num_rows > 0) {
            ...
            if ($update_stmt->execute()) {
                ...
                $movimiento_query = "INSERT INTO movimiento_repuesto (id_repuesto, id_almacen_origen, cantidad, descripcion, id_tipo_movimiento) VALUES (?, ?, ?, ?, ?)";
            ...
            $_SESSION['error'] = "repuesto no encontrado en el inventario.";
            header("Location: formulario_inventario_repuesto.php");
            exit();
        }
