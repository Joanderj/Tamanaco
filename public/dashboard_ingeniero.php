...
<div class="relative overflow-hidden rounded-3xl shadow-2xl border border-indigo-700 bg-gradient-to-br from-gray-900 via-gray-800 to-indigo-900 p-6 animate-fade-in-up">
    <div class="absolute -top-10 -left-10 w-32 h-32 bg-indigo-500 rounded-full opacity-30 blur-2xl animate-pulse"></div>
    <div class="absolute -bottom-10 -right-10 w-40 h-40 bg-blue-600 rounded-full opacity-20 blur-3xl animate-pulse"></div>

    <div class="flex flex-col md:flex-row items-center justify-center gap-6 z-10 ">
        <!-- Icono central -->
        <div class="flex items-center justify-center bg-indigo-700 text-white rounded-full w-20 h-20 shadow-lg border-4 border-indigo-300">
        ...
        <div class="text-center">
            <h1 class="text-3xl md:text-5xl font-extrabold text-white tracking-wider flex items-center justify-center gap-4">
                <i class="fas fa-hard-hat drop-shadow-md"></i>
                Panel del <span class="text-indigo-400 drop-shadow-md">Ingeniero</span>
                <i class="fas fa-hard-hat drop-shadow-md"></i>
            </h1>

            <p class="text-gray-300 mt-2 text-sm md:text-base font-medium">
                Planifica, supervisa y ejecuta cada proceso con precisión técnica. Plataforma diseñada para el control estratégico del mantenimiento.
            </p>
        </div>
    </div>
</div>
