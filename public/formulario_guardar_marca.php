...
<?php endif; ?>
    ...
    <form action="guardar_marca.php" method="POST" class="space-y-4" id="form-marca">
        <!-- Nombre de la Marca -->
        <div>
       ...
       oninput="convertirMayusculas(this); validarNombreMarca()">
        ...
        <i class="fas fa-link text-blue-500 mr-2"></i> <!-- Ícono de vincular -->
         Vincular Modelos:<span class="text-red-600">*</span>
        </label>
    ...
    Seleccionar un modelo <span class="text-red-600">*</span>
</label>
        ...
        <div id="vincular_varios" class="hidden">
            <label class="block font-semibold"><i class="fas fa-cube text-blue-500 mr-2"></i> <!-- Ícono de modelo -->Selecciona los modelos <span class="text-red-600">*</span></label>
    ...
    fetch('guardar_modelo_marca.php', {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                const selectModelo = document.getElementById('modelo_uno');
                const nuevaOpcion = document.createElement('option');
                nuevaOpcion.value = data.id_modelo;
                nuevaOpcion.textContent = data.nombre_modelo;
                selectModelo.appendChild(nuevaOpcion); // Agregar al select

                // Mostrar mensaje de éxito
                mostrarMensaje('success', '¡Modelo se a guardado exitosamente!');
