    ...
    <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
        <div class="flex flex-col items-center mb-6">
            ...
            <div class="bg-blue-500 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-lg mb-4">
                <i class="fas fa-user-tie text-3xl"></i> <!-- Ícono de proveedor -->
            </div>
            <!-- Título del formulario -->
            <h2 class="text-3xl font-extrabold text-gray-800">Formulario de Proveedor</h2>
            <!-- Descripción del formulario -->
            <p class="text-gray-600 mt-2 text-center">Registra la información de los proveedores de forma clara y profesional.</p>
        </div>
...
<!-- Formulario -->
<form id="providerForm" action="modificar_proveedor.php" method="post">
    ...
    <div class="mb-4">
        ...
        <input oninput="this.value = this.value.toUpperCase();" type="text" id="nombre_proveedor" name="nombre_proveedor" value="<?= htmlspecialchars($proveedor['nombre_proveedor']) ?>" placeholder="Nombre del proveedor..." class="w-full border border-gray-300 rounded-lg p-2" required>
    ...
    <div class="mb-4">
        ...
        <input  type="text" id="telefono" name="telefono" value="<?= htmlspecialchars($proveedor['telefono']) ?>" placeholder="Teléfono del proveedor..." class="w-full border border-gray-300 rounded-lg p-2">
    ...
    <div class="mb-4">
        ...
        <input oninput="this.value = this.value.toUpperCase();" type="email" id="email" name="email" value="<?= htmlspecialchars($proveedor['email']) ?>" placeholder="Email del proveedor..." class="w-full border border-gray-300 rounded-lg p-2">
    ...
    <div class="mb-4">
        ...
        <textarea oninput="this.value = this.value.toUpperCase();" id="direccion" name="direccion" placeholder="Dirección del proveedor..." class="w-full border border-gray-300 rounded-lg p-2"><?= htmlspecialchars($proveedor['direccion']) ?></textarea>
    ...
    <div class="flex justify-between mt-4 space-x-4">
        ...
        <button type="button" onclick="location.href='proveedor.php';" class="bg-blue-500 text-white py-2 px-6 rounded-lg flex items-center hover:bg-blue-600 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-300">
