...
<div class="p-6 bg-gray-50 rounded shadow-md">
  ...
  <div class="text-center mb-6">
    ...
    <p class="text-gray-600 text-sm">Consulta y analiza los datos con precisión.</p>
  </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
    <!-- Rango de Fechas -->
    <div>
      <label for="dateRange" class="text-gray-700 font-semibold">Rango de Fechas</label>
      <input type="text" id="dateRange" class="w-full mt-2 py-2 px-3 border rounded-lg shadow focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent" placeholder="Selecciona fechas">
    </div>
    <!-- Tipo de Reporte -->
    <div>
      <label for="reportType" class="text-gray-700 font-semibold">Tipo de Reporte</label>
      <select id="reportType" class="w-full mt-2 py-2 px-3 border rounded-lg shadow focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent">
        <option value="default" disabled selected>Selecciona un tipo...</option>
  ...
  <div class="flex justify-center mb-6">
    <button class="bg-green-500 text-white py-2 px-4 rounded-lg shadow-md hover:bg-green-600 focus:ring-2 focus:ring-green-300 focus:outline-none">
      <i class="fas fa-file-alt mr-2"></i> Generar Reporte
    </button>
  </div>

  <!-- Resultados o Gráfica -->
  <div class="p-4 bg-green-50 border rounded-lg shadow-inner">
    <canvas id="reportChart" class="w-full h-64"></canvas>
  </div>
</div>

<script>
  // Gráfica de ejemplo con Chart.js
  ...
  const reportChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        data: [5, 10, 7, 12, 15], // Datos de muestra
