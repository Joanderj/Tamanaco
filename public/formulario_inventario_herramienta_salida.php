...
?>
        ...
        <!-- Formulario General -->
     <form id="formRegistrarsucursal" action="actualizar_herramienta_salida.php" method="POST">
    ...
    <div class="mb-4">
        ...
        <!-- Almacen -->
        <div>
            <label for="almacen" class="block text-gray-700 mb-2">
                <i class="fas fa-warehouse text-blue-500 mr-2"></i>Almacén<span class="text-red-600">*</span>
            </label>
            <select 
                id="almacen" 
                name="almacen"
    ...
    <div>
        <label for="motivo" class="block font-semibold">
            <i class="fas fa-exclamation-circle text-blue-500 mr-2"></i>Motivo
        </label>
        <select name="motivo" id="motivo" class="w-full border border-gray-300 rounded-lg p-2">
