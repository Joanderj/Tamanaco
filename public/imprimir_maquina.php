...
// Consulta de todas las máquinas
$sql = "SELECT 
            m.id_maquina, 
            m.nombre_maquina, 
...
if ($resultado->num_rows == 0) {
    die("No hay máquinas registradas");
}

$pdf = new TCPDF();
$pdf->SetCreator(PDF_CREATOR);
$pdf->SetTitle('Listado de Máquinas');
$pdf->SetMargins(10, 10, 10);
$pdf->AddPage();

$estiloTabla = 'style="border-collapse: collapse;"';

while ($maquina = $resultado->fetch_assoc()) {
    ...
    <tr>
        <td width="40%" align="center">';
    $html .= !empty($rutaImagen) ? '<img src="' . $rutaImagen . '" width="150">' : 'Sin imagen disponible';
    $html .= '</td>
        <td width="60%">
            <table width="100%" cellpadding="5" cellspacing="0" ' . $estiloTabla . '>
                <tr>
...
$conexion->close();
$pdf->Output('reporte_todas_maquinas.pdf', 'I');
?>
