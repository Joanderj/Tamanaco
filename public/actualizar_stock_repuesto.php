...
$sql = "SELECT stock_minimo, stock_maximo FROM inventario_repuesto WHERE id_inventario_repuesto = ?";
...
$sql = "UPDATE inventario_repuesto SET $field = ? WHERE id_inventario_repuesto = ?";
$stmt = $conexion->prepare($sql);
