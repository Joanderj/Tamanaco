...
?>
        ...
        <!-- Formulario General -->
         <form id="formRegistrarsucursal" action="actualizar_producto_entrada.php" method="POST">
    <!-- Nombre de la sucursal -->
    <div class="mb-4">
    <div>
                <label for="producto" class="block text-gray-700 mb-2"><i class="fas fa-box text-blue-500 mr-2"></i>Producto<span class="text-red-600">*</span></label>
                <select 
                  id="producto" 
                  name="producto"
