    ...
    <div class="text-center mb-6">
        <div class="relative w-64 h-64 mx-auto border-2 border-dashed border-blue-500 rounded-lg flex justify-center items-center">
            ...
            <div id="imagen-placeholder" class="text-center">
                <i class="fas fa-cogs text-3xl text-blue-500"></i> <!-- Ícono de engranajes -->
    ...
    document.getElementById('imagen').onchange = function(evt) {
        ...
        if (file) {
            ...
            document.getElementById('imagen-placeholder').classList.add('hidden');
                ...
                <div>
                    <label for="nombre_repuesto" class="block font-semibold flex items-center">
                        <i class="fas fa-tag text-blue-500 mr-2"></i> <!-- Ícono de marca -->
                        Nombre del Repuesto: <span class="text-red-600">*</span>
                    </label>
                    <input type="text" id="nombre_repuesto" name="nombre_repuesto" placeholder="Nombre del repuesto..." class="w-full border border-gray-300 rounded-lg p-2" required>
                           <!-- Mensajes específicos para el input -->
            <small id="mensaje-error-input" class="text-red-500 hidden">Este repuesto ya existe</small>
            <small id="mensaje-exito-input" class="text-green-500 hidden">¡Este repuesto está disponible!</small>
            <small class="text-gray-500">Ejemplo: Filtro de Aceite</small>
                </div>

                <!-- Selección de Marca -->
                <div>
                    <label for="marca" class="block font-semibold flex items-center">
                        <i class="fas fa-industry text-blue-500 mr-2"></i> <!-- Ícono de marca -->
                ...
                <div>
                    ...
                    <select id="tipo" name="tipo" class="w-full border border-gray-300 rounded-lg p-2" required>
   ...
   <!-- Sugerencia de Mantenimiento -->
    <div class="mb-4">
        <label for="sugerencia_mantenimiento" class="block font-semibold flex items-center">
            ...
            Sugerencia de Mantenimiento: <span class="text-red-600">*</span>
        </label>
        ...
        <small class="text-gray-500">Ejemplo: Seleccione cada cuánto tiempo se recomienda realizar el mantenimiento.</small>
    </div>
    ...
    <!-- Aquí se cargarán dinámicamente -->
                ...
                <div class="flex justify-between mt-4 space-x-4">
                    ...
                    <!-- Botón Regresar -->
                    <button type="button" onclick="location.href='repuesto.php';" class="bg-blue-500 text-white py-2 px-6 rounded-lg flex items-center hover:bg-blue-600 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-300">
