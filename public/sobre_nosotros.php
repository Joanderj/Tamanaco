...
</span>ror de conexión: " . $conexion->connect_error);
}
...
<div class="flex flex-col items-center mb-6">
    ...
    <h2 class="text-3xl font-extrabold text-gray-800">Sobre Nosotros</h2>
    <p class="text-gray-600 mt-2 text-center">Conoce más sobre la historia, misión, visión y objetivos de nuestra empresa.</p>
</div>
...
?>
  <!-- Formulario -->
  <form action="guardar_cambios_sobre_nosotros.php" method="POST">
    <!-- Historia -->
    <div class="relative mb-6">
      <label for="historia" class="block font-medium text-gray-600">Historia:</label>
      <textarea id="historia" rows="4" name='historia' value="<?php echo $empresa['historia']; ?>" placeholder="Escribe aquí la historia de la empresa..." class="w-full p-3 border border-gray-300 rounded-lg bg-gray-100 focus:outline-none" > <?php echo $empresa['historia']; ?></textarea>
    ...
    <!-- Visión -->
    <div class="relative mb-6">
      <label for="vision" class="block font-medium text-gray-600">Visión:</label>
      <textarea id="vision" rows="4" name='vision' value="<?php echo $empresa['vision']; ?>" placeholder="Escribe aquí la visión de la empresa..." class="w-full p-3 border border-gray-300 rounded-lg bg-gray-100 focus:outline-none" ><?php echo $empresa['vision']; ?>"</textarea>
      <button type="button" class="absolute top-2 right-2 text-gray-500 hover:text-blue-500">
        <i class="fas fa-pencil-alt"></i>
      </button>
    </div>
    ...
    <!-- Misión -->
    <div class="relative mb-6">
      <label for="mision" class="block font-medium text-gray-600">Misión:</label>
      <textarea id="mision" rows="4" name='mision' value="<?php echo $empresa['mision']; ?>" placeholder="Escribe aquí la misión de la empresa..." class="w-full p-3 border border-gray-300 rounded-lg bg-gray-100 focus:outline-none" ><?php echo $empresa['mision']; ?></textarea>
      <button type="button" class="absolute top-2 right-2 text-gray-500 hover:text-blue-500">
        <i class="fas fa-pencil-alt"></i>
      </button>
    </div>
    ...
    <!-- Objetivo Específico -->
    <div class="relative mb-6">
      <label for="objetivoEspecifico" class="block font-medium text-gray-600">Objetivo Específico:</label>
      <textarea id="objetivoEspecifico" rows="4" name='especificos' value="<?php echo $empresa['objetivos_especificos']; ?>" placeholder="Escribe aquí el objetivo específico..." class="w-full p-3 border border-gray-300 rounded-lg bg-gray-100 focus:outline-none" ><?php echo $empresa['objetivos_especificos']; ?></textarea>
      <button type="button" class="absolute top-2 right-2 text-gray-500 hover:text-blue-500">
        <i class="fas fa-pencil-alt"></i>
      </button>
    </div>
    ...
    <!-- Objetivo General -->
    <div class="relative mb-6">
      <label for="objetivoGeneral" class="block font-medium text-gray-600">Objetivo General:</label>
      <textarea id="objetivoGeneral" rows="4" name='general' value="<?php echo $empresa['objetivo_general']; ?>" placeholder="Escribe aquí el objetivo general..." class="w-full p-3 border border-gray-300 rounded-lg bg-gray-100 focus:outline-none" ><?php echo $empresa['objetivo_general']; ?></textarea>
      <button type="button" class="absolute top-2 right-2 text-gray-500 hover:text-blue-500">
        <i class="fas fa-pencil-alt"></i>
      </button>
    </div>
