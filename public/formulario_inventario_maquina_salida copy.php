...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-6">
        <div class="flex flex-col items-center mb-6">
            ...
            <p class="text-gray-600 mt-2 text-center">Realiza movimientos de salida</p>
        </div>
...
?>
      ...
      <!-- Formulario Mejorado -->
<form id="formRegistrarsucursal" action="actualizar_maquina_salida.php" method="POST" class="max-w-2xl mx-auto bg-white p-6 rounded-xl shadow-md">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6 flex items-center">
        <i class="fas fa-tools text-indigo-600 mr-2"></i> Registro de Máquina en Sede
    </h2>
    ...
    <div class="mb-5">
        <label for="sede" class="block text-gray-700 font-medium mb-2">
            <i class="fas fa-map-marker-alt text-blue-500 mr-1"></i>Sede<span class="text-red-600">*</span>
        </label>
        <select 
            id="sede" 
            name="sede"
...
function updateCodigo() {
    ...
    if (maquina && sede) {
        fetch(`obtener_codigos.php?maquina=${maquina}&sede=${sede}`)
            .then(res => res.json())
            .then(data => {
