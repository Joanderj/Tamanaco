...
<!-- Encabezado Profesional para el Panel del Ingeniero -->
<div class="relative overflow-hidden rounded-3xl shadow-2xl border border-emerald-700 bg-gradient-to-br from-gray-900 via-gray-800 to-emerald-900 p-6 animate-fade-in-up">
    <div class="absolute -top-10 -left-10 w-32 h-32 bg-emerald-500 rounded-full opacity-30 blur-2xl animate-pulse"></div>
    <div class="absolute -bottom-10 -right-10 w-40 h-40 bg-green-600 rounded-full opacity-20 blur-3xl animate-pulse"></div>

    <div class="flex flex-col md:flex-row items-center justify-center gap-6 z-10 ">
        <!-- Icono central -->
        <div class="flex items-center justify-center bg-emerald-700 text-white rounded-full w-20 h-20 shadow-lg border-4 border-emerald-300">
        ...
        <div class="text-center">
            <h1 class="text-3xl md:text-5xl font-extrabold text-white tracking-wider flex items-center justify-center gap-4">
                <i class="fas fa-user-shield drop-shadow-md"></i>
                Panel del <span class="text-emerald-400 drop-shadow-md">Administrador</span>
                <i class="fas fa-user-shield drop-shadow-md"></i>
            </h1>

            <p class="text-gray-300 mt-2 text-sm md:text-base font-medium">
                Supervisa, gestiona y controla todos los procesos administrativos con eficiencia. Plataforma diseñada para la gestión estratégica y toma de decisiones.
            </p>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 p-6 font-sans animate-fade-in">
  ...
  <!-- Inventario -->
  <div class="group relative rounded-3xl bg-gradient-to-br from-blue-600 via-blue-500 to-indigo-700 text-white shadow-xl p-6 border border-blue-400 hover:shadow-blue-500/60 transition-all duration-500 transform hover:-translate-y-2 overflow-hidden">
    <div class="absolute -top-10 -left-10 w-40 h-40 bg-blue-300 opacity-30 rounded-full blur-2xl group-hover:animate-ping"></div>
    <div class="flex items-center gap-4 mb-6 z-10 relative">
      <div class="bg-white p-4 rounded-xl shadow-lg text-blue-700">
        <i class="fas fa-box text-2xl"></i>
      </div>
      <h2 class="text-2xl font-extrabold tracking-wider">Inventario</h2>
    </div>
    <p class="text-blue-100">Stock crítico detectado:</p>
    <p class="text-5xl font-black text-yellow-300 my-3 drop-shadow">5</p>
    <p class="text-sm text-blue-100 mb-6">Monitoreo en tiempo real de tus productos.</p>
    <button class="w-full bg-white text-blue-700 py-2 rounded-xl font-semibold hover:bg-blue-100 transition duration-300 shadow-md">
      Ver detalles
    </button>
  </div>

  <!-- Reposición -->
  <div class="group relative rounded-3xl bg-gradient-to-br from-purple-600 via-fuchsia-600 to-pink-600 text-white shadow-xl p-6 border border-pink-400 hover:shadow-pink-500/60 transition-all duration-500 transform hover:-translate-y-2 overflow-hidden">
    <div class="absolute -bottom-10 -right-10 w-40 h-40 bg-pink-300 opacity-30 rounded-full blur-2xl group-hover:animate-ping"></div>
    <div class="flex items-center gap-4 mb-6 z-10 relative">
      <div class="bg-white p-4 rounded-xl shadow-lg text-pink-700">
        <i class="fas fa-sync-alt text-2xl animate-spin-slow"></i>
      </div>
      <h2 class="text-2xl font-extrabold tracking-wider">Reposiciones</h2>
    </div>
    <p class="text-pink-100">Productos por reponer:</p>
    <p class="text-5xl font-black text-yellow-200 my-3 drop-shadow">7</p>
    <p class="text-sm text-pink-100 mb-6">Alertas inteligentes de escasez.</p>
    <button class="w-full bg-white text-pink-700 py-2 rounded-xl font-semibold hover:bg-pink-100 transition duration-300 shadow-md">
      Gestionar
    </button>
  </div>

 <!-- Historial -->
<div class="group relative rounded-3xl bg-gradient-to-br from-red-500 via-amber-600 to-red-700 text-white shadow-xl p-6 border border-yellow-400 hover:shadow-yellow-500/60 transition-all duration-500 transform hover:-translate-y-2 overflow-hidden">
  <div class="absolute top-0 left-0 w-20 h-20 bg-red-300 opacity-20 blur-2xl group-hover:animate-ping"></div>
  <div class="flex items-center gap-4 mb-6 z-10 relative">
    <div class="bg-white p-4 rounded-xl shadow-lg text-red-700">
      <i class="fas fa-history text-2xl"></i>
    </div>
    <h2 class="text-2xl font-extrabold tracking-wider">Historial</h2>
  </div>
  <p class="text-red-100">Registros recientes:</p>
  <p class="text-sm text-red-100 mt-2 mb-6">Seguimiento completo de entradas y salidas.</p>
  <button onclick="window.location.href='historial_movimiento.php'" class="w-full bg-white text-red-700 py-2 rounded-xl font-semibold hover:bg-yellow-100 transition duration-300 shadow-md">
    Ver historial
  </button>
</div>
