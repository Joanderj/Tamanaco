...
<?php if ($showWelcomeMessage): ?>
        <div id="welcome-message" class="fixed top-4 right-4 bg-blue-500 text-white rounded-lg shadow-lg p-4 max-w-xs z-50">
            <div class="flex justify-between items-center">
                <h3 class="text-lg font-bold">¡Bienvenido!</h3>
                <button class="text-white text-xl hover:text-red-300" onclick="closeWelcomeMessage()">×</button>
            </div>
            <p class="mt-2 text-sm">
                Estamos encantados de que estés aquí. Explora nuestras funciones y aprovecha al máximo tu experiencia.
            </p>
        </div>
    <?php endif; ?>
...
switch ($_SESSION['id_perfil']) {
    case 6: // Recursos Humanos
        include 'dashboard_rrhh.php';
        break;
    case 4: // Mecánico
        include 'dashboard_mecanico.php';
        break;
    case 7: // Coordinador de Compras
        include 'dashboard_compras.php';
        break;
        case 2: // Coordinador de Compras
        include 'dashboard_ingeniero.php';
        break;
        case 3: // Coordinador de Compras
        include 'dashboard_gerente.php';
        break;
        case 5: // asistente
        include 'dashboard_asistente.php';
        break;
    default:
        include 'dashboard_general.php';
}
?>
