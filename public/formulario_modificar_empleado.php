...
<?php
include 'db_connection.php'; // tu archivo de conexión a BD
...
$sql = "SELECT p.*, c.id_cargo, c.nombre_cargo
        FROM personas p
...
<!-- Contenedor Principal -->
    ...
    <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <!-- Formulario -->
        <form action="modificar_empleado.php" method="post" id="formEmpleado">
...
<div class="mb-6">
    ...
    <div class="flex items-center space-x-6 mt-2">
        <label class="flex items-center space-x-2 cursor-pointer">
           <input disabled type="radio" name="nacionalidad" value="V" <?= ($usuario['nacionalidad'] == 'V') ? 'checked' : '' ?> >

            <span class="text-gray-700">Venezolana</span>
        </label>
        <label class="flex items-center space-x-2 cursor-pointer">
           <input disabled type="radio" name="nacionalidad" value="E" <?= ($usuario['nacionalidad'] == 'E') ? 'checked' : '' ?> >
...
<div class="mb-6">
    ...
    <input type="text" id="cedula" name="cedula" placeholder="Ingrese su cédula" 
           class="w-full border border-gray-300 rounded-lg p-3 bg-gray-100 cursor-not-allowed" value="<?= $usuario['cedula'] ?>" disabled>
</div>
...
<div class="grid grid-cols-2 gap-6">
    <div>
        ...
        <input value="<?= $usuario['primer_nombre'] ?>" oninput="this.value = this.value.toUpperCase();" type="text" id="nombre" name="nombre" placeholder="Primer nombre" class="w-full border border-gray-300 rounded-lg p-2" required>
    ...
    <div>
        ...
        <input value="<?= $usuario['segundo_nombre'] ?>" oninput="this.value = this.value.toUpperCase();" type="text" id="segundo_nombre" name="segundo_nombre" placeholder="Segundo nombre" class="w-full border border-gray-300 rounded-lg p-2">
...
<div class="grid grid-cols-2 gap-6 mt-4">
    <div>
        ...
        <input value="<?= $usuario['primer_apellido'] ?>" oninput="this.value = this.value.toUpperCase();" type="text" id="apellido" name="apellido" placeholder="Primer apellido" class="w-full border border-gray-300 rounded-lg p-2" required>
    ...
    <div>
        ...
        <input value="<?= $usuario['segundo_apellido'] ?>" oninput="this.value = this.value.toUpperCase();" type="text" id="segundo_apellido" name="segundo_apellido" placeholder="Segundo apellido" class="w-full border border-gray-300 rounded-lg p-2">
...
<div class="grid grid-cols-2 gap-6 mb-6">
    ...
    <div>
        ...
        <input value="<?= $usuario['fecha_nacimiento'] ?>" type="date" id="fecha_nacimiento" name="fecha_nacimiento" 
    ...
    <div>
        ...
        <input value="<?= $usuario['edad'] ?>" type="number" id="edad" name="edad" placeholder="Edad" 
...
<div>
    ...
    <select id="cargo" name="cargo" class="w-full border border-gray-300 rounded-lg p-3 bg-white" required>
        ...
        while ($fila = $resultado->fetch_assoc()) {
            echo "<option value='" . $fila['id_cargo'] . "' " . ($fila['id_cargo'] == $usuario['id_cargo'] ? 'selected' : '') . ">" . $fila['nombre_cargo'] . "</option>";
...
<div class="grid grid-cols-2 gap-6 mb-6">
    ...
    <input value="<?= $usuario['primer_nombre'] ?>" style="width: 410px;" type="tel" id="telefono" name="telefono" placeholder="+58 4149551156"
    ...
    <div>
        ...
        <input value="<?= $usuario['correo_electronico'] ?>" oninput="this.value = this.value.toUpperCase();" type="email" id="email" name="email" placeholder="tamanaco@gmail.com"
...
<div class="border-b-2 border-blue-500 shadow-md mb-4 pb-2">
    ...
    <div class="grid grid-cols-2 gap-6 mt-2">
        ...
        <div>
            ...
            <select id="pais" name='pais' class="w-full border border-gray-300 rounded-lg p-3 bg-white" >
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<option value='$id' " . ($usuario['pais_id'] == $id ? 'selected' : '') . ">$nombre</option>";
                    }
                } else {
        ...
        <div>
           ...
           <select 
            ...
            >
                ...
                <?php
                // Solo mostrar estados si hay un país seleccionado
                if (isset($perfil['pais_id'])) {
                    // Conexión a la base de datos
                    $conexion = new mysqli("localhost", "root", "", "bd_tamanaco");
                    ...
                    $query = "SELECT id, estadonombre FROM estado WHERE ubicacionpaisid = ? ORDER BY estadonombre ASC";
                    $stmt = $conexion->prepare($query);
                    $stmt->bind_param("i", $perfil['pais_id']);
                    $stmt->execute();
                    $result = $stmt->get_result();
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<option value='$idestado' " . ($usuario['estado_id'] == $idestado ? 'selected' : '') . ">$nombreestado</option>";
                        }
                    } else {
...
<div class="mb-6">
    ...
    <textarea  oninput="this.value = this.value.toUpperCase();" id="descripcion" name="descripcion" rows="4" 
              ...
              placeholder="Ingrese detalles de su ubicación, como calle, edificio, referencias..."><?= $usuario['direccion'] ?></textarea>
 ...
 <p class="text-gray-500 text-sm mt-4">Todos los campos marcados con <span class="text-red-600">*</span> son obligatorios.</p>
          <input type="text" name="id_persona" value="<?= $id_persona ?>" class="hidden">
            <!-- Botones -->
