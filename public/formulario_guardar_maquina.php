...
<?php endif; ?>
    ...
    <form id="machineForm" action="guardar_maquina.php" method="post" enctype="multipart/form-data">
    <div class="text-center mb-6">
        <div class="relative w-64 h-64 mx-auto border-2 border-dashed border-blue-500 rounded-lg flex justify-center items-center">
            ...
            <div id="imagen-placeholder" class="text-center">
                <i class="fas fa-tools text-3xl text-blue-500"></i> <!-- Ícono de herramientas -->
    ...
    <div class="mb-4">
        <label for="codigo_maquina" class="block font-semibold flex items-center">
            <i class="fas fa-barcode text-blue-500 mr-2"></i>
            Código de la Máquina: <span class="text-red-600">*</span>
        </label>
        <input oninput="this.value = this.value.toUpperCase();" type="text" id="codigo_maquina" name="codigo_maquina" placeholder="Ej: MAQ" class="w-full border border-gray-300 rounded-lg p-2" required>
        <small class="text-gray-500">Ingrese un código único para la máquina.</small>
    </div>
    <!-- Nombre de la Máquina -->
    <div class="mb-4">
        <label for="nombre_maquina" class="block font-semibold flex items-center">
            <i class="fas fa-cogs text-green-500 mr-2"></i>
            Nombre de la Máquina: <span class="text-red-600">*</span>
        </label>
        <input oninput="this.value = this.value.toUpperCase();" type="text" id="nombre_maquina" name="nombre_maquina" placeholder="Nombre de la máquina..." class="w-full border border-gray-300 rounded-lg p-2" required>
        <small id="mensaje-error-input" class="text-red-500 hidden">Esta maquina ya existe</small>
        <small id="mensaje-exito-input" class="text-green-500 hidden">¡Esta maquina está disponible!</small>
        <small class="text-gray-500">Ejemplo: Taladro Industrial </small>
    </div>
    ...
    <div class="mb-4">
        ...
        <input type="hidden" id="descripcion_funcionamiento" name="descripcion_funcionamiento">
        <div id="editor" class="w-full border border-gray-300 p-2"></div>
    </div>
    ...
    <script>
        ...
        document.getElementById('machineForm').onsubmit = function () {
            ...
            return true;  // Make sure the form gets submitted
        };
    </script>
    ...
    <div class="mb-4">
        ...
        <input oninput="this.value = this.value.toUpperCase();" type="text" id="elaborada_por" name="elaborada_por" placeholder="Nombre del fabricante..." class="w-full border border-gray-300 rounded-lg p-2">
    </div>

   
<!-- Campo de Marca -->
<div class="mb-4">
    <label for="id_marca" class="block font-semibold flex items-center">
        <i class="fas fa-industry text-orange-500 mr-2"></i> <!-- Ícono -->
...
<!-- Campo de Modelo -->
<div class="mb-4">
    <label for="id_modelo" class="block font-semibold flex items-center">
        <i class="fas fa-cube text-yellow-500 mr-2"></i> <!-- Ícono -->
    ...
    <div class="mb-4">
        ...
        <select id="tipo" name="tipo" class="w-full border border-gray-300 rounded-lg p-2" required>
            ...
            <?php
            $conexion = new mysqli('localhost', 'root', '', 'bd_tamanaco');
            $consulta = "SELECT id_tipo, nombre_tipo FROM tipo WHERE id_status = 1";
...
<div class="flex flex-col items-center justify-center   px-4">
  <div class="bg-white shadow-lg rounded-xl p-6 w-full max-w-sm flex flex-col items-center">
    ...
    <!-- Título -->
    <h2 class="text-lg font-semibold text-gray-700 mb-4">Selecciona un color para la maquina</h2>
    ...
    <div class="flex flex-col items-center">
      ...
      <p class="text-sm text-gray-600">Color seleccionado: 
        <span id="colorHex" class="font-mono text-gray-800">#f00</span>
      </p>
    </div>
