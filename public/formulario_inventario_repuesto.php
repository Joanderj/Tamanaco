...
<hr>
    <!-- Formulario Actualizar Inventario de repuestos -->
<div class="container mx-auto px-4 py-6">
    <div class="max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-6">
        <div class="flex flex-col items-center mb-6">
            ...
            <h2 class="text-3xl font-extrabold text-gray-800">Actualizar Inventario de repuestos</h2>
...
?>
        ...
        <!-- Formulario General -->
         <form id="formRegistrarsucursal" action="actualizar_repuesto_entrada.php" method="POST">
    <!-- Nombre de la sucursal -->
    <div class="mb-4">
    <div>
                <label for="repuesto" class="block text-gray-700 mb-2"><i class="fas fa-box text-blue-500 mr-2"></i>repuesto<span class="text-red-600">*</span></label>
                <select 
                  id="repuesto" 
                  name="repuesto"
                  class="w-full border border-gray-300 rounded p-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                >
                    <option value="">Selecciona una repuesto</option>
                    <?php
                    // Conexión a la base de datos
                    $conexion = new mysqli("localhost", "root", "", "bd_tamanaco");
    ...
    <input type="number" id="cantidad" name="cantidad" placeholder="Ingrese la Cantidad"
           class="border border-gray-300 rounded p-2 w-full" required min="0">
</div>

            <!-- pais -->
            <div>
                <label for="almacen" class="block text-gray-700 mb-2"><i class="fas fa-warehouse text-blue-500 mr-2"></i>Almacen<span class="text-red-600">*</span></label>
                <select 
                  id="almacen" 
                  name="almacen"
                  class="w-full border border-gray-300 rounded p-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
