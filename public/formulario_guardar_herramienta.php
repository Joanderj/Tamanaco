...
<form action="guardar_herramienta.php" method="post" enctype="multipart/form-data">
    ...
    <div>
        <label for="nombre_herramienta" class="block font-semibold flex items-center">
            ...
            Nombre de la Herramienta: <span class="text-red-600">*</span>
        </label>
        <input type="text" id="nombre_herramienta" name="nombre_herramienta" placeholder="Nombre de la herramienta..." class="w-full border border-gray-300 rounded-lg p-2" required>
    ...
    <div>
        ...
        <textarea id="descripcion" name="descripcion" placeholder="Detalles de la herramienta..." class="w-full border border-gray-300 rounded-lg p-2"></textarea>
    </div>
...
<div>
    ...
    <div class="flex justify-between mt-4 space-x-4">
        ...
        <button type="button" onclick="location.href='herramienta.php';" class="bg-blue-500 text-white py-2 px-6 rounded-lg flex items-center hover:bg-blue-600 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-300">
