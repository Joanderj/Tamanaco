...
$sql = "SELECT stock_minimo, stock_maximo FROM inventario_herramientas WHERE id_inventario_herramienta = ?";
...
$sql = "UPDATE inventario_herramientas SET $field = ? WHERE id_inventario_herramienta = ?";
$stmt = $conexion->prepare($sql);
...
if ($stmt->execute()) {
    ...
    $sql_reorden = "
        ...
        WHERE id_inventario_herramienta = ?";
