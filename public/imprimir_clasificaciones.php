...
$pdf->SetTitle('Listado de Clasificaciones');
...
$pdf->Cell(0, 10, 'Listado de Clasificaciones', 0, 1, 'C');
$pdf->Ln(5);
...
// Consulta para obtener las clasificaciones
$sql = "SELECT id_clasificacion, nombre_clasificacion, abreviacion_clasificacion FROM clasificacion";
...
if ($resultado->num_rows > 0) {
    ...
    $tbl = '<table border="1" cellpadding="6" style="border-collapse:collapse;">
                <thead>
                    <tr style="background-color:#0066CC; color:#FFFFFF;">
                        ...
                        <th width="30%" align="center">Abreviación</th>
                    </tr>
                </thead>
                <tbody>';
    ...
    while ($fila = $resultado->fetch_assoc()) {
        $tbl .= '<tr>
                    <td align="center">' . $fila['id_clasificacion'] . '</td>
                    <td>' . $fila['nombre_clasificacion'] . '</td>
                    <td align="center">' . $fila['abreviacion_clasificacion'] . '</td>
                 </tr>';
    }
    $tbl .= '</tbody></table>';
    ...
    $pdf->Cell(0, 10, 'No se encontraron clasificaciones en la base de datos.', 0, 1, 'C');
}
...
$pdf->Output('listado_clasificaciones.pdf', 'I');
?>
